...
var userConfigs = {
	...
	sendChatMessage:function(obj,callback){
		pushfyi.publish("hb_user_channel",obj);
	}
};
...
function checkChatBoxInputKey(event,chatboxtextarea,chatboxtitle) {
	...
	if(event.keyCode == 13 && event.shiftKey == 0)  {
		...
		if (message != '') {
		    ...
		    userConfigs.sendChatMessage({to: chatboxtitle, message: message}, function(data){
				...
				$("#chatbox_"+chatboxtitle+" .chatboxcontent").scrollTop($("#chatbox_"+chatboxtitle+" .chatboxcontent")[0].scrollHeight);
				//userConfigs
				if (userConfigs.noSupportUserAssigned)
